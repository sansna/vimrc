...
inoremap <c-c> <ESC>
""shortcut for esc, this is considered harmful rather than helpful
"inoremap jk <ESC>
...
function SetPYOptions()
    nnoremap <leader>S :!python %<CR>:!sleep 2<CR>:!rm %c<CR>:let __line=line('.')<CR>:let __col=col('.')<CR>:w !sudo tee % 2>&1 1>/dev/null<CR>:edit!<CR><CR>:cal cursor(__line, __col)<CR>:unlet __line<CR>:unlet __col<CR>
endfunction
